---
name: spec-execute
description: Execute an approved plan. Use when the user says 'plan approved' or 'start executing' in reference to a plan. Should *only* use this on a plan generated by the spec-plan skill.
version: 1
created: 2026-05-30
---
